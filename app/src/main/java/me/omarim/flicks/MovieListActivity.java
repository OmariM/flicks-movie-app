...
public class MovieListActivity extends AppCompatActivity {
    ...
    String posterSize;
    // the list of currently plaing movies
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // initialize the addapter -- movies array connot be reinitialized after this point
        adapter = new MovieAdapter(movies);

        //resolve the recycler view and connect a layout managerand the adpter
